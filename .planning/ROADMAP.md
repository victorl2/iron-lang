...
- v0.0.5-alpha IR Optimization & High IR Architecture - Phases 15-20 (active)
...
### v0.0.5-alpha IR Optimization & High IR Architecture

- [ ] **Phase 15: Copy Propagation, DCE & Constant Folding** - Simpler optimization passes in a new ir_optimize.c module eliminate redundant copies, dead instructions, and compile-time constants
- [ ] **Phase 16: Expression Inlining** - Reconstruct compound C expressions during emission for single-use pure values, closing the largest performance gap
- [ ] **Phase 17: Strength Reduction & Store/Load Elimination** - Replace expensive loop index patterns with induction variables and remove redundant memory operations
- [ ] **Phase 18: Benchmark Validation** - All 127 benchmarks pass at their configured parity thresholds with 100% pass rate
- [ ] **Phase 19: LIR Rename & HIR Foundation** - Current IR renamed to Lower IR throughout codebase; High IR data structures, printer, and verifier established
- [ ] **Phase 20: HIR Lowering & Pipeline Cutover** - AST-to-HIR and HIR-to-LIR lowering passes replace the direct AST-to-LIR path
...
- [ ] 15-02-PLAN.md — Implement copy propagation, constant folding, DCE with fixpoint loop
- [ ] 15-03-PLAN.md — Unit tests and .iron integration tests for all three passes
...
- [ ] 16-02-PLAN.md — Integration tests for expression inlining across Iron features
- [ ] 16-03-PLAN.md — Benchmark parity assertion for median_two_sorted_arrays
...
- [ ] 18-02-PLAN.md — Benchmark runner --json output and --compare mode
- [ ] 18-03-PLAN.md — 10 concurrency correctness benchmarks
- [ ] 18-04-PLAN.md — Threshold tuning and full suite validation
...
| 20. HIR Lowering & Pipeline Cutover | 6/7 | In Progress|  | - |

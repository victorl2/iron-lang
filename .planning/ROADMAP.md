...
- [x] 74-02-PLAN.md — 14 per-category API reference pages with shared 14-entry sidebar (wave 2, depends_on 74-01)
- [x] 74-03-PLAN.md — Examples gallery + 5 screenshots + link validation + mobile-responsive polish (wave 3, depends_on 74-02)

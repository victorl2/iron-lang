/* tests/fuzz/fuzz_typecheck.c — FUZZ-02 libFuzzer target for iron_typecheck.
 *
 * Phase 68 Plan 01 skeleton: the entry point exists and returns 0
 * on every input. Real implementation lands in Plan 04 (FUZZ-02).
 *
...
int LLVMFuzzerTestOneInput(const uint8_t *Data, size_t Size) {
    (void)Data; (void)Size;
    /* Plan 01: skeleton — real typecheck driver in Plan 04. */
    return 0;
}

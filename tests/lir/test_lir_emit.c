...
void test_emit_hello_world(void) {
    ...
    const char *result = iron_lir_emit_c(mod, &out_arena, &g_diags, &opt_info_1, NULL, false);
...
void test_emit_arithmetic(void) {
    ...
    const char *result = iron_lir_emit_c(mod, &out_arena, &g_diags, &opt_info_2, NULL, false);
...
void test_emit_control_flow(void) {
    ...
    const char *result = iron_lir_emit_c(mod, &out_arena, &g_diags, &opt_info_3, NULL, false);
...
void test_emit_alloca_load_store(void) {
    ...
    const char *result = iron_lir_emit_c(mod, &out_arena, &g_diags, &opt_info_4, NULL, false);
...
void test_emit_type_decl_object(void) {
    ...
    const char *result = iron_lir_emit_c(mod, &out_arena, &g_diags, &opt_info_5, NULL, false);
...
void test_emit_phi_elimination(void) {
    ...
    const char *result = iron_lir_emit_c(mod, &out_arena, &g_diags, &opt_info_6, NULL, false);
...
void test_emit_expression_inlining_basic(void) {
    ...
    const char *result = iron_lir_emit_c(mod, &out_arena, &g_diags, &opt_info, NULL, false);

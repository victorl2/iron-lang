...
> Tagged from `main` at SHA `982f6c04`. Acceptance corpus pass-rate at milestone close: see [Acceptance corpus pass-rate](#acceptance-corpus-pass-rate) below (measured on silvaserver, `iron-lsp-build:latest` 8 GB podman). Full reproducer in `docs/dev/PHASE-36-CLOSEOUT.md`.
...
The v3 → v4 syntax delta is mechanical for most user code but structural for code that relies on implicit mutation or unbounded references. The [migration guide](https://github.com/victorl2/iron-lang/blob/982f6c046ae2ed0f73fff932bc718cbeafa8af60/docs/site/migration-v3-to-v4.md) walks through every change with before/after code blocks.
...
- [Migration guide (v3 → v4)](https://github.com/victorl2/iron-lang/blob/982f6c046ae2ed0f73fff932bc718cbeafa8af60/docs/site/migration-v3-to-v4.md)
- [LSP memory-model reference](https://github.com/victorl2/iron-lang/blob/982f6c046ae2ed0f73fff932bc718cbeafa8af60/docs/dev/LSP-MEMORY-MODEL.md)
- [Stdlib container reference](https://github.com/victorl2/iron-lang/blob/982f6c046ae2ed0f73fff932bc718cbeafa8af60/docs/dev/STDLIB-CONTAINERS.md)
- [Phase 35 closeout (corpus migration)](https://github.com/victorl2/iron-lang/blob/982f6c046ae2ed0f73fff932bc718cbeafa8af60/docs/dev/PHASE-35-CLOSEOUT.md)
- [Phase 36 closeout (this release)](https://github.com/victorl2/iron-lang/blob/982f6c046ae2ed0f73fff932bc718cbeafa8af60/docs/dev/PHASE-36-CLOSEOUT.md)
